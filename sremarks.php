...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <?php
            ...
            $query = "SELECT * FROM remarks WHERE sno = '".$_SESSION['sno']."' and sem='".$_SESSION['sem']."'";
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                $show= $show.'<div class="card text-white bg-danger wow flipInX">
                                <h5 class="card-header">'.$ok['name'].'</h5>
                                <div class="card-body">
                                    <h5 class="card-title">'.$row["remarks"].'</h5>
                                </div>
                            </div> <br> <br>';
                }
