...
<div class="row">
    ...
    <form action="./includs/addmarks.php" method="POST" class="form-group">
            ...
            <input type="text" name="marks" placeholder="Students marks here" class="form-control">
            <input type="text" name="sub" value="<?php echo $_GET['sub']   ?>"class="d-none">

            <br><br>
            <button type="submit" class="bn btn-info btn-block btn-lg">Add Marks </button>
    </form>    
    </div>
    <div class="col"></div>
</div>
...
if(isset($_GET['app'])) {
    echo "<p style='color:red' class='text-center'> marks has been successfully added </p>";
}else{
    echo "";
}
